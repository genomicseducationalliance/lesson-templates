...
a citation of the data:
      ...
      **How to use provided sample data**
      ...
      In this lesson, we will use an RNA-Seq dataset (*"Zika infected hNPCs"*).
...
Many lessons will have step-by-step instructions for students to follow
    ...
    1. First, enter the cutoff value for your dataset
        ...
        .. admonition:: Sample data
          ...
          If you are using the *"Zika infected hNPCs"* dataset:
          Enter **30**

    2. If you are presenting a lesson with code, it will displayed with the
       proper formatting
...
the **defined_substitutions.txt** file in this repo for easy future
updating.
